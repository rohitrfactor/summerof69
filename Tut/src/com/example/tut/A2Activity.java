...
public class A2Activity extends FragmentActivity {
    /**
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_settings) {
	        ...
	        prefsEditor.putString("sample", "com.example.tut.A2Activity");
	        prefsEditor.commit();
    ...
    public static class DemoObjectFragment extends Fragment {
      ...
      /*  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    public List<dailytimetable> getDataForListView(int position)
	    {
    		...
    		thru3.SubjectName="EE";
    		thru3.Location="A-315";
    		thru3.Type="Tut";
    		thru3.Time1="1:45";
    		thru3.Time2="2:40";
    		...
    		thru6.SubjectName="Physics";
    		thru6.Location="A-317";
    		thru6.Type="Tut";
    		thru6.Time1="4:30";
    		thru6.Time2="6:00";
    		...
    		fri3.SubjectName="Chemistry";
    		fri3.Location="Lab UG";
    		fri3.Type="Lab";
    		fri3.Time1="10:40";
    		fri3.Time2="12:30";
    		dailyList4.add(fri3);

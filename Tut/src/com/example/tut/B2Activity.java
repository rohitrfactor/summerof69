...
public class B2Activity extends FragmentActivity {
    ...
    public static class DemoObjectFragment extends Fragment {
      ...
      /*  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    public List<dailytimetable> getDataForListView(int position)
	    {
    		...
    		friD3.SubjectName="EE";
    		friD3.Location="A-315";
    		friD3.Type="Tut";
    		friD3.Time1="2:40";
    		friD3.Time2="3:35";
    		...
    		fri3d.SubjectName="Chemistry";
    		fri3d.Location="Lab UG";
    		fri3d.Type="Lab";
    		fri3d.Time1="4:35";
    		fri3d.Time2="6:00";

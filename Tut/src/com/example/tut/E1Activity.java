...
public class E1Activity extends FragmentActivity {
    ...
    public static class DemoObjectFragment extends Fragment {
      ...
      /*  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    public List<dailytimetable> getDataForListView(int position)
	    {
    		...
    		chapter5.SubjectName = "Physics";
    		chapter5.Location = "A-301";
    		chapter5.Type = "Tut";
    		chapter5.Time1 = "2:40";
    		chapter5.Time2 = "4:30";
    		...
    		random6.SubjectName ="Math";
    		random6.Location ="A-301";
    		random6.Type ="Tut";
    		random6.Time1 = "2:40";
    		random6.Time2 ="3:35";
    		...
    		random7.SubjectName ="EE";
    		random7.Location ="A-301";
    		random7.Type ="Tut";
    		random7.Time1 = "3:35";
    		random7.Time2 ="4:30";
    		...
    		wed1.SubjectName="Chemistry";
    		wed1.Location="EH G.Floor";
    		wed1.Type="Tut";
    		wed1.Time1="12:30";
    		wed1.Time2="1:45";
    		dailyList2.add(wed1);
    		...
    		wed7.SubjectName="Chemistry";
    		wed7.Location="LAb UG";
    		wed7.Type="Lab";
    		wed7.Time1="4:30";
    		wed7.Time2="6:00";
    		dailyList2.add(wed7);

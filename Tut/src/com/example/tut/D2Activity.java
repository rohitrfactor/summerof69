...
public class D2Activity extends FragmentActivity {
    ...
    public static class DemoObjectFragment extends Fragment {
      ...
      /*  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    public List<dailytimetable> getDataForListView(int position)
	    {
    		...
    		chapte2.SubjectName = "EE";
    		chapte2.Location = "A-316";
    		chapte2.Type = "Tut";
    		chapte2.Time2 = "12:30";
    		chapte2.Time1 = "11:35";
    		...
    		dailytimetable random61 = new dailytimetable();
    		random61.SubjectName ="Math";
    		random61.Location ="A-314";
    		random61.Type ="Tut";
    		random61.Time1 = "2:40";
    		random61.Time2 ="3:35";
    		dailyList1.add(random61);
    		dailytimetable random6 = new dailytimetable();
    		random6.SubjectName ="Chemistry";
    		random6.Location ="A-314";
    		random6.Type ="Tut";
    		random6.Time1 = "3:35";
    		random6.Time2 ="4:30";
